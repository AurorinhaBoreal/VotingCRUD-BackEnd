...
public class AgendaMapperWrapper {
    public Agenda dtoToAgenda(AgendaRequest agendaRequest, Category agendaCategory, LocalDateTime agendaFinish) {
        return AgendaMapper.dtoToAgenda(agendaRequest, agendaCategory, agendaFinish);
    }
}
